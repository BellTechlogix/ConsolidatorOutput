...
$ConsolidatorUsers = import-csv $path$filename|select BusUnit,ComplianceRegion,DefaultPassword,Dept,Effective_Date,@{N='EmailAddress';E={$_.EmailAddress.ToLower()}},Employee_ID,FirstName,HireDate,JobCode,Title,LastName,MiddleName,TaxID,Status,SupervisorID,@{N='UserID';E={$_.EmailAddress.ToLower()}},LocationDesc,LocationPhone,LocationCity,LocationState,LocationZip,LocationCode,SEC_Role,ID_Check,Supports_User_Rename,Supports_User_Reopen,Monitored,UnMonitored,DefaultCountry,Date_Format
